...
class PreferencesPithosDialog(gtk.Dialog):
    ...
    def setup_fields(self):
        ...
        self.builder.get_object('prefs_audio_format').set_model(fmt_store)
        self.builder.get_object('prefs_audio_format').set_text_column(0)
        self.builder.get_object('prefs_audio_format').set_active(audio_pref_idx)
    ...
    def ok(self, widget, data=None):
        ...
        self.__preferences["audio_format"] = self.builder.get_object('prefs_audio_format').child.get_text()
