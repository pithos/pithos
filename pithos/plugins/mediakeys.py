...
class MediaKeyPlugin(PithosPlugin):
    ...
    def bind_dbus(self):
        try:
            ...
            mk = bus.get_object("org.gnome.SettingsDaemon",
                                "/org/gnome/SettingsDaemon/MediaKeys")
            mk.GrabMediaPlayerKeys(
                APP_ID, 0, dbus_interface='org.gnome.SettingsDaemon.MediaKeys')
            mk.connect_to_signal(
                "MediaPlayerKeyPressed", self.mediakey_pressed)
    ...
    def on_enable(self):
        self.bind_dbus() or self.bind_keybinder() or logging.error(
            "Could not bind media keys")
